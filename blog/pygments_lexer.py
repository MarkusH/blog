...
class JNILexer(RegexLexer):
    ...
    tokens = {
        "whitespace": [
            ...
            # or with whitespace
            ("^(" + _ws + r")(#if\s+0)", bygroups(using(this), Comment.Preproc), "if0"),
            ("^(" + _ws + ")(#)", bygroups(using(this), Comment.Preproc), "macro"),
        ...
        "statements": [
            ...
            (
                ...
                r"switch|typedef|union|volatile|virtual|while)\b",
                Keyword,
            ),
            (
                (
                    r"(int|long|float|short|double|char|unsigned|signed|"
                    r"void|jint|jstring|jclass|JNIEnv)\b"
                ),
                Keyword.Type,
            ),
            ...
            (
                ...
                r"declspec|finally|int64|try|leave)\b",
                Keyword.Reserved,
            ),
